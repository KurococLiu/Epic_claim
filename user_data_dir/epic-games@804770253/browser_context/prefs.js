...
user_pref("app.update.lastUpdateTime.addon-background-update-timer", 1728167567);
user_pref("app.update.lastUpdateTime.background-update-timer", 1728167567);
user_pref("app.update.lastUpdateTime.browser-cleanup-thumbnails", 1728167567);
user_pref("app.update.lastUpdateTime.region-update-timer", 1727649048);
user_pref("app.update.lastUpdateTime.services-settings-poll-changes", 1728167567);
user_pref("app.update.lastUpdateTime.telemetry_modules_ping", 1726985199);
user_pref("app.update.lastUpdateTime.xpi-signature-verification", 1728167567);
...
user_pref("browser.startup.lastColdStartupCheck", 1728167537);
...
user_pref("media.gmp-manager.lastCheck", 1728167562);
user_pref("media.gmp-manager.lastEmptyCheck", 1728167562);
...
user_pref("toolkit.startup.last_success", 1728167536);
