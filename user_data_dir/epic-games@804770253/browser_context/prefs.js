...
user_pref("app.update.lastUpdateTime.addon-background-update-timer", 1727735514);
user_pref("app.update.lastUpdateTime.background-update-timer", 1727735514);
user_pref("app.update.lastUpdateTime.browser-cleanup-thumbnails", 1727735514);
user_pref("app.update.lastUpdateTime.region-update-timer", 1727649048);
user_pref("app.update.lastUpdateTime.services-settings-poll-changes", 1727735514);
user_pref("app.update.lastUpdateTime.telemetry_modules_ping", 1726985199);
user_pref("app.update.lastUpdateTime.xpi-signature-verification", 1727735514);
...
user_pref("browser.contextual-services.contextId", "{5e09465a-83e7-4d03-83cd-87a77c144e9c}");
...
user_pref("browser.newtabpage.activity-stream.impressionId", "{abe63dd6-ebca-460a-9c58-1a90add3ae25}");
...
user_pref("browser.startup.lastColdStartupCheck", 1727735484);
...
user_pref("extensions.formautofill.creditCards.reauth.optout", "MDIEEPgAAAAAAAAAAAAAAAAAAAEwFAYIKoZIhvcNAwcECC7WXiUKVpFqBAiSZI/p6WmvbQ==");
...
user_pref("extensions.webextensions.uuids", "{\"formautofill@mozilla.org\":\"2355025f-44dd-4709-ba5d-2f7a2b01ca94\",\"pictureinpicture@mozilla.org\":\"d6fc9dc4-a9d6-410d-89e8-f43d9856a6c0\",\"screenshots@mozilla.org\":\"704eddff-2343-40e6-9ce0-5fc93dd9de8b\",\"webcompat-reporter@mozilla.org\":\"272ada6e-074b-49b8-a8db-16eafd777d16\",\"webcompat@mozilla.org\":\"6a6bdd27-cd00-48c4-a1ed-dff09f00815b\",\"default-theme@mozilla.org\":\"51d43137-9f22-4083-a1df-1d9fd4852e62\",\"addons-search-detection@mozilla.com\":\"d4599208-4d26-42f6-a41a-9ea855decd5b\"}");
...
user_pref("media.gmp-manager.lastCheck", 1727735509);
user_pref("media.gmp-manager.lastEmptyCheck", 1727735509);
...
user_pref("security.sandbox.content.tempDirSuffix", "b3ab53ef-2d7b-4ffd-894e-407ed3eb3595");
user_pref("security.sandbox.warn_unprivileged_namespaces", false);
user_pref("services.settings.server", "");
user_pref("signon.autofillForms", false);
user_pref("signon.management.page.os-auth.optout", "MDIEEPgAAAAAAAAAAAAAAAAAAAEwFAYIKoZIhvcNAwcECI20MHE19rGGBAjEV5pOLUS4FA==");
user_pref("signon.rememberSignons", false);
user_pref("startup.homepage_welcome_url", "about:blank");
user_pref("toolkit.cosmeticAnimations.enabled", false);
user_pref("toolkit.shutdown.fastShutdownStage", 3);
user_pref("toolkit.startup.last_success", 1727735483);
